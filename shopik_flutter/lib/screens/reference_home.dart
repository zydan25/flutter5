        ...
        child: SafeArea(
          ...
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(4, 'كشف حساب', Icons.receipt_long_rounded, Icons.receipt_long_outlined, AppColors.teal),
              _buildNavItem(5, 'الإعدادات', Icons.settings_rounded, Icons.settings_outlined, const Color(0xFF475569)),
            ],
          ),
        ),
      ),
